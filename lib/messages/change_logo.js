...
const message_factory = (user_id, club_name, logo_url, path) => {
  const view_1 = {
    ...
    callback_id: 'change_logo_view_1', // view identifier
    blocks: [
      {
        type: 'section',
        text: {
          type: 'mrkdwn',
          text: `*Hey <@${user_id}>!* :wave:\nHere is the current logo of your club:`,
        },
      },
      {
        type: 'image',
        title: {
          type: 'plain_text',
          text: `${club_name}'s logo'`,
        },
        block_id: `club logo image`,
        image_url: logo_url,
        alt_text: `${club_name}'s logo`,
      },
      {
        type: 'input',
        block_id: 'logo_input_block',
        element: {
          type: 'plain_text_input',
          action_id: 'logo_input_action',
          placeholder: {
            type: 'plain_text',
            text: 'enter new link',
          },
