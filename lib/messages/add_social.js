  ...
  const view_1 = {
    ...
    blocks: [
      ...
      },
      {
        ...
        hint: {
          type: "plain_text",
          text: "enter a valid link in the above input box, valid links starts with https://",
        },
      },
    ],
  };
  ...
  blocks: [
    {
      ...
      text: {
        type: "mrkdwn",
        text: `*Hey <@${user_id}>!* :wave:\n\nyour club's *${key} url has been updated :yay:, these changes can take upto 60mins to reflect* on our leaderboard.`,
      },
    },
    {
      type: "image",
